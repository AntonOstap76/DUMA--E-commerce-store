...
export const routes: Routes = [
    ...
    {path:'**', redirectTo:'not-found', pathMatch:'full'}// if request is uncorrect or doesnt exist in redirect to fot found error
];
